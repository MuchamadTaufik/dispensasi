        ...
        <li class="nav-item dropdown no-arrow mx-1">
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                @if($notificationCounter == 0)
                    <p class="dropdown-item text-center small text-gray-500">Tidak ada notifikasi.</p>
                @endif
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                @foreach(auth()->user()->notifications->whereIn('type', ['App\Notifications\DispensasiApprove', 'App\Notifications\DispensasiReject']) as $notification)
                    <a class="{{ $notification->type == 'App\Notifications\DispensasiApprove' }} dropdown-item d-flex align-items-center">
