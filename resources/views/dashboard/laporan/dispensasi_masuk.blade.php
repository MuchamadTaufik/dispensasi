...
<body>
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold">Data Dispensasi Masuk MAN 2 Kota Bandung pada Tahun ({{ $selectedYear }})</h6>
        </div>
        <div class="card-body">
            <table class="table table-bordered" id="dataTable">
                ...
                <tbody>
                    @php
                        $dispensasis = $dispensasis->where('status_id', 2)->sortByDesc('created_at'); // Mengurutkan notifikasi berdasarkan waktu terbaru
                    @endphp
